...
import time, sys
import ps_drone                                     
from math import cos,sin,pi                          # Import PS-Drone-API
...
while not end:
    ...
    print "Altitude / sensor / pressure: "+str(drone.NavData["altitude"][3])+" / "+str(drone.NavData["altitude"][3]*cos(drone.NavData["demo"][2][0])*pi/180.0)+" / "+str(drone.NavData["pressure_raw"][0])
